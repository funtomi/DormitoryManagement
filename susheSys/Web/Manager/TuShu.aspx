<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TuShu.aspx.cs" Inherits="Manager_TuShu" %>
        ...
        <TR>
          <TD height=2 align="left">
                ...
                <asp:TemplateField HeaderText="入住日期">
                  ...
                  <asp:TemplateField HeaderText="退宿日期">
                    <ItemTemplate>
                        <asp:Label ID="tuchudate" runat="server" Text='<%# Bind("tuchudate") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="center"   />
                </asp:TemplateField>
