<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuSheList.aspx.cs" Inherits="Manager_SuSheList" %>
        ...
        <TR>
          <TD height=2 align="left">
                ...
                <asp:TemplateField HeaderText="宿舍名称">
                    <ItemTemplate>
                        <asp:Label ID="Label11" runat="server" Text='<%# Bind("ssname") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "SuSheAdd.aspx?id="+Eval("id") %>'
                            Text="修改"></asp:HyperLink>
                             <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "SuSheDelete.aspx?id="+Eval("id") %>'
