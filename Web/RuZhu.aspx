<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RuZhu.aspx.cs" Inherits="RuZhu" %>
              ...
              >
                            <Columns>
                                ...
                                <asp:BoundField DataField="ruzhudate" HeaderText="入住时间">
                                 ...
                                 <asp:BoundField DataField="ruzhudate" HeaderText="退宿时间">
                                    <ItemStyle ForeColor="Black" />
                                </asp:BoundField>
